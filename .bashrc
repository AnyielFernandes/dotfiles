...
if ${use_color} ; then
	...
	if [[ ${EUID} == 0 ]] ; then
		...
		export PS1="\[\033[100m\]\[\e[2m\][\[\e[00m\]\[\033[100m\]\[\033[01;32m\]\u\[\e[34m\] \w \[\e[31m\] (\`nonzero_return\`)\[\033[01;32m\]\[\033[95m\]\[\e[32m\]\[\e[2m\] \`parse_git_branch\` \[\e[36m\]\d\\[\e[36m\], \A]\n\[\033[00m\]" 
	fi
...
alias vi=nvim
alias vim=nvim
alias viconf="vi /home/anyel/.config/nvim/init.vim"
alias ..="cd .." 
alias .=pwd
